<!-- Navbar -->
  <nav class="main-header navbar navbar-expand navbar-dark navbar-dark ">
    ...
    <div class="container">
      ...
      <?php endif; ?>
        <li>
          <a class="nav-link text-white"  href="./" role="button"> <large><b>AJewellery Online Shop</b></large></a>
        </li>
      </ul>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <?php else: ?>
          ...
          <li class="nav-item">
            <a class="nav-link nav-login" href="index.php?page=history_price" id="login">
              <b>Daily Price</b>
            </a>
          </li>
