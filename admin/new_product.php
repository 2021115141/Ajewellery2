...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
						<div class="form-group">
							<label for="" class="control-label">Wages</label>
							<input type="text" class="form-control form-control-sm" name="wages" value="<?php echo isset($wages) ? $wages : '' ?>">
						</div>
					</div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control form-control-sm text-right number" name="type" value="<?php echo isset($type) ? number_format($type) : '' ?>">
            </div>
          </div>
				</div>
        <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label for="" class="control-label">Available Weight</label>
            </div>
            <?php if(isset($id) && $id > 0): ?>
            <?php 
            $weights = $conn->query("SELECT * FROM weights where product_id = $id");
                  if($weights->num_rows > 0): 
            while($row = $weights->fetch_assoc()):
            ?>
            <div class="form-group">
              <div class="input-group mb-3">
                  <input type="hidden" class="form-control" name="wid[]" value="<?php echo $row['id'] ?>">
            ...
            <div class="form-group">
              <div class="d-flex justify-content-end w-100">
                <button class="btn btn-flat bg-light border" type="button" id="add_weight"><i class="fa fa-plus"></i> Add Weight </button>
              </div>
            </div>
          </div>
        </div>
    	...
    	<div class="card-footer border-top border-info">
    		<div class="d-flex w-100 justify-content-center align-items-center">
    			...
    			<a href="index.php?page=product_list"><button class="btn btn-flat bg-gradient-secondary mx-2" type="button">Cancel</button></a>
    		</div>
    	</div>
	</div>
</div>
